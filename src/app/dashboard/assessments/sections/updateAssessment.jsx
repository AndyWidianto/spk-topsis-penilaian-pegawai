    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setSubmitted(true);
                cancel();
                dispatch(updateAssessmentInPriode(resJson));
            }
        } catch (err) {
            console.error(err);
        } finally {
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
                    ...
                    <div className="mt-8 flex justify-end gap-4">
                        <button
                            ...
                            className="px-8 py-3 bg-gray-200 hover:bg-gray-250 text-gray-500 font-semibold rounded-lg transition-all duration-200 active:scale-95"
                        >
                            cancel
                        </button>
                        <button
